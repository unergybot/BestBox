  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 p-4 shadow-sm hover:shadow-md transition-shadow">
      ...
      <div className="text-xs text-gray-400 italic">
        External service - managed externally
      </div>
      )}
    </div>
  );
    ...
    try {
      ...
      if (!res.ok) {
        if (res.status === 401 || res.status === 403) {
          throw new Error("Access denied. Please log in with admin credentials.");
        }
  ...
  return (
    <div className="p-6">
      <header className="mb-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">Manage BestBox services and monitor health</p>
          </div>
          <button
      ...
      <div className="mb-6 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="font-semibold text-blue-900">Advanced Monitoring</h3>
            <p className="text-sm text-blue-700 mt-1">
              For detailed health checks, uptime history, response times, and alerting, visit the Gatus status page.
            </p>
          </div>
          <a
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
          <div className="text-sm text-gray-500 mb-1">Stopped</div>
